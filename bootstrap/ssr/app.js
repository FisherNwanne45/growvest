...
const sharedComposable = () => {
  ...
  const formatCurrency = (amount = 0, iconType = "name") => {
    ...
    if (iconType === "name") {
      formattedCurrency = currency.position === "right" ? `${currency.name} ${formattedAmount}` : `${currency.icon} ${formattedAmount}`;
    } else if (iconType === "both") {
      formattedCurrency = `${currency.icon}${formattedAmount} ${currency.name}`;
    } else {
      formattedCurrency = currency.position === "right" ? `${formattedAmount}${currency.icon}` : `${currency.icon}${formattedAmount}`;
    }
...
const ValidationErrors = /* @__PURE__ */ _export_sfc(_sfc_main$2J, [["__scopeId", "data-v-5f297af4"]]);
class Dropdown {
...
const __default__$26 = {
  layout: _sfc_main$2H
};
const _sfc_main$2G = /* @__PURE__ */ Object.assign(__default__$26, {
  __name: "Create",
  __ssrInlineRender: true,
...
const __default__$25 = {
  layout: _sfc_main$2H
};
const _sfc_main$2E = /* @__PURE__ */ Object.assign(__default__$25, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$24 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2C = /* @__PURE__ */ Object.assign(__default__$24, {
  __name: "Index",
  __ssrInlineRender: true,
...
const __default__$23 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2z = /* @__PURE__ */ Object.assign(__default__$23, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "categories",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.categories.total) {
        ...
        _push(ssrRenderComponent(_sfc_main$2A, { "for-table": "true" }, null, _parent));
      }
...
const __default__$22 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2y = /* @__PURE__ */ Object.assign(__default__$22, {
  __name: "Create",
  __ssrInlineRender: true,
...
const __default__$21 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2x = /* @__PURE__ */ Object.assign(__default__$21, {
  __name: "Edit",
  __ssrInlineRender: true,
  props: [
    "info",
...
const __default__$20 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2u = /* @__PURE__ */ Object.assign(__default__$20, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "posts",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2v, { options: filterOptions }, null, _parent));
...
const __default__$1$ = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2t = /* @__PURE__ */ Object.assign(__default__$1$, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "tags",
...
const __default__$1_ = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2s = /* @__PURE__ */ Object.assign(__default__$1_, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "brands",
...
const _sfc_main$2r = /* @__PURE__ */ Object.assign(__default__$1Z, {
  __name: "Index",
  __ssrInlineRender: true,
...
const __default__$1Y = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2q = /* @__PURE__ */ Object.assign(__default__$1Y, {
  __name: "Index",
  __ssrInlineRender: true,
  props: ["currencies", "buttons", "segments"],
  setup(__props) {
    sharedComposable();
    onMounted(() => {
      drawer.init();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="space-y-6"><div class="table-responsive whitespace-nowrap rounded-primary"><table class="table"><thead><tr><th class="col-2">${ssrInterpolate(unref(trans)("Code"))}</th><th class="col-2">${ssrInterpolate(unref(trans)("Name"))}</th><th class="flex justify-end">${ssrInterpolate(unref(trans)("Action"))}</th></tr></thead><tbody><!--[-->`);
      ssrRenderList(__props.currencies, (currency) => {
        _push(`<tr><td class="text-left">${ssrInterpolate(currency.code)}</td><td class="text-left">${ssrInterpolate(currency.name)}</td><td class="flex justify-end gap-3"><button class="delete-confirm btn btn-primary"><i class="fas fa-edit"></i></button><a href="javascript:void(0)" class="delete-confirm btn btn-primary"><i class="fas fa-trash"></i></a></td></tr>`);
      });
      _push(`<!--]--></tbody></table></div></div></main><div id="addNewCurrencyDrawer" class="drawer drawer-right"><form><div class="drawer-header"><h5>${ssrInterpolate(unref(trans)("Add New Currency"))}</h5><button type="button" class="btn btn-plain-secondary dark:text-slate-300 dark:hover:bg-slate-700 dark:focus:bg-slate-700" data-dismiss="drawer"><i data-feather="x" width="1.5rem" height="1.5rem"></i></button></div><div class="drawer-body"><div class="mb-2"><label>${ssrInterpolate(unref(trans)("Name"))}</label><input${ssrRenderAttr("value", unref(form).name)} type="text" name="name" class="input" required placeholder="US"></div><div class="mb-2"><label>${ssrInterpolate(unref(trans)("Code"))}</label><input${ssrRenderAttr("value", unref(form).code)} type="text" name="name" class="input" required placeholder="USD"></div></div><div class="drawer-footer"><div class="flex justify-end gap-2"><button type="button" class="btn btn-secondary" data-dismiss="drawer"><span>${ssrInterpolate(unref(trans)("Close"))}</span></button>`);
      _push(ssrRenderComponent(_sfc_main$2F, {
        classes: "btn btn-primary",
        processing: unref(form).processing,
        "btn-text": unref(trans)("Create")
      }, null, _parent));
      _push(`</div></div></form></div><div id="editCurrencyDrawer" class="drawer drawer-right"><form><div class="drawer-header"><h5>${ssrInterpolate(unref(trans)("Edit Currency"))}</h5><button type="button" class="btn btn-plain-secondary dark:text-slate-300 dark:hover:bg-slate-700 dark:focus:bg-slate-700" data-dismiss="drawer"><i data-feather="x" width="1.5rem" height="1.5rem"></i></button></div><div class="drawer-body"><div class="mb-2"><label class="label mb-2">${ssrInterpolate(unref(trans)("Name"))}</label><input${ssrRenderAttr("value", editForm.value.name)} type="text" name="name" class="input" required></div><div class="mb-2"><label class="label mb-2">${ssrInterpolate(unref(trans)("Code"))}</label><input${ssrRenderAttr("value", editForm.value.code)} type="text" name="code" class="input" required></div></div><div class="drawer-footer"><div class="flex justify-end gap-2"><button type="button" class="btn btn-secondary" data-dismiss="drawer"><span>${ssrInterpolate(unref(trans)("Close"))}</span></button>`);
      _push(ssrRenderComponent(_sfc_main$2F, {
        processing: isProcessing.value,
        classes: "btn btn-primary",
        "btn-text": unref(trans)("Save Changes")
...
_sfc_main$2q.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Currency/Index.vue");
...
const __default__$1X = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2p = /* @__PURE__ */ Object.assign(__default__$1X, {
  __name: "Show",
  __ssrInlineRender: true,
...
_sfc_main$2p.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Currency/Show.vue");
...
const __default__$1W = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2o = /* @__PURE__ */ Object.assign(__default__$1W, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "customers",
...
const __default__$1V = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2n = /* @__PURE__ */ Object.assign(__default__$1V, {
  __name: "Show",
  __ssrInlineRender: true,
...
const __default__$1U = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2m = /* @__PURE__ */ Object.assign(__default__$1U, {
  __name: "Dashboard",
  __ssrInlineRender: true,
  props: [
    "totalInvest",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_a3 = __props.recentEvents) == null ? void 0 : _a3.length) > 0) {
        ...
        _push(ssrRenderComponent(_sfc_main$2D, { text: "Nothing found..." }, null, _parent));
      }
...
const _sfc_main$2l = /* @__PURE__ */ Object.assign(__default__$1T, {
  __name: "App",
  __ssrInlineRender: true,
  props: [
    "segments",
...
const __default__$1S = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2j = /* @__PURE__ */ Object.assign(__default__$1S, {
  __name: "Cookie",
  __ssrInlineRender: true,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2k, {
        processing: unref(form).processing,
        "btn-text": _ctx.trans("Save Changes")
      }, null, _parent));
      _push(`</div></div></div></form></div></div></div></main>`);
...
const __default__$1R = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2i = /* @__PURE__ */ Object.assign(__default__$1R, {
  __name: "Features",
  __ssrInlineRender: true,
  props: [
    "id",
...
const _sfc_main$2h = /* @__PURE__ */ Object.assign(__default__$1Q, {
  __name: "Newsletter",
  __ssrInlineRender: true,
  props: [
    "segments",
...
const _sfc_main$2g = /* @__PURE__ */ Object.assign(__default__$1P, {
  __name: "Smtp",
  __ssrInlineRender: true,
  props: [
    "id",
...
const __default__$1O = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2f = /* @__PURE__ */ Object.assign(__default__$1O, {
  __name: "SocialLogin",
  __ssrInlineRender: true,
  props: [
    "segments",
...
const _sfc_main$2e = /* @__PURE__ */ Object.assign(__default__$1N, {
  __name: "Storage",
  __ssrInlineRender: true,
  props: [
    "id",
...
const __default__$1M = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2d = /* @__PURE__ */ Object.assign(__default__$1M, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "segments",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2B, { items: orderOverviews }, null, _parent));
...
const __default__$1L = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2c = /* @__PURE__ */ Object.assign(__default__$1L, {
  __name: "Show",
  __ssrInlineRender: true,
  props: [
    "order",
...
const __default__$1K = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$2a = /* @__PURE__ */ Object.assign(__default__$1K, {
  __name: "Create",
  __ssrInlineRender: true,
...
const __default__$1J = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$29 = /* @__PURE__ */ Object.assign(__default__$1J, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$1I = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$28 = /* @__PURE__ */ Object.assign(__default__$1I, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "buttons",
...
const __default__$1H = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$27 = /* @__PURE__ */ Object.assign(__default__$1H, {
  __name: "Participants",
  __ssrInlineRender: true,
...
const _sfc_main$26 = /* @__PURE__ */ Object.assign(__default__$1G, {
  __name: "Index",
  __ssrInlineRender: true,
...
const _sfc_main$25 = /* @__PURE__ */ Object.assign(__default__$1F, {
  __name: "Create",
  __ssrInlineRender: true,
...
const _sfc_main$24 = /* @__PURE__ */ Object.assign(__default__$1E, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$1D = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$23 = /* @__PURE__ */ Object.assign(__default__$1D, {
  __name: "Index",
  __ssrInlineRender: true,
...
const _sfc_main$22 = /* @__PURE__ */ Object.assign(__default__$1C, {
  __name: "Create",
  __ssrInlineRender: true,
...
const __default__$1B = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$21 = /* @__PURE__ */ Object.assign(__default__$1B, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$1A = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$20 = /* @__PURE__ */ Object.assign(__default__$1A, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "gateways",
...
const __default__$1z = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1$ = /* @__PURE__ */ Object.assign(__default__$1z, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "investments",
...
const __default__$1y = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1_ = /* @__PURE__ */ Object.assign(__default__$1y, {
  __name: "Create",
  __ssrInlineRender: true,
  props: ["buttons", "segments"],
  setup(__props) {
...
const __default__$1x = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1Z = /* @__PURE__ */ Object.assign(__default__$1x, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$1w = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1Y = /* @__PURE__ */ Object.assign(__default__$1w, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "posts",
...
const __default__$1v = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1X = /* @__PURE__ */ Object.assign(__default__$1v, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "jobs",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="space-y-6">`);
      _push(ssrRenderComponent(_sfc_main$2B, {
        items: jobStats.value,
        grid: "3"
      }, null, _parent));
      _push(`<div class="flex items-center justify-end gap-x-2"><div class="dropdown" data-placement="bottom-end"><div class="dropdown-toggle"><button type="button" class="btn bg-white font-medium shadow-sm dark:bg-slate-800"><i class="w-4" data-feather="filter"></i><span>${ssrInterpolate(unref(trans)("Filter"))}</span><i class="w-4" data-feather="chevron-down"></i></button></div><div class="dropdown-content w-72 !overflow-visible"><form><ul class="dropdown-list space-y-4 p-4"><li class="dropdown-list-item"><h2 class="my-1 text-sm font-medium">${ssrInterpolate(unref(trans)("Search"))}</h2><div class="mb-2">`);
      if (unref(filterData).type && unref(filterData).type === "status") {
        _push(`<select class="select" name="type"><option value="1">${ssrInterpolate(unref(trans)("Active"))}</option><option value="0">${ssrInterpolate(unref(trans)("Inactive"))}</option></select>`);
      } else {
        _push(`<input type="text" name="search"${ssrRenderAttr("value", unref(filterData).search)} class="input" placeholder="Search......">`);
      }
      _push(`</div></li><li class="dropdown-list-item"><div class="mb-2"><select class="select" name="type"><option value="email">${ssrInterpolate(unref(trans)("Company Email"))}</option><option value="name">${ssrInterpolate(unref(trans)("Company Name"))}</option><option value="title">${ssrInterpolate(unref(trans)("Title"))}</option><option value="status">${ssrInterpolate(unref(trans)("Status"))}</option><option value="service">${ssrInterpolate(unref(trans)("Service"))}</option><option value="category">${ssrInterpolate(unref(trans)("Category"))}</option></select></div></li><li class="dropdown-list-item"><button type="submit" class="btn btn-primary w-full">${ssrInterpolate(unref(trans)("Filter"))}</button></li></ul></form></div></div></div><div class="table-responsive whitespace-nowrap rounded-primary"><table class="table"><thead><tr><th class="">${ssrInterpolate(unref(trans)("Name"))}</th><th class="">${ssrInterpolate(unref(trans)("Company Name"))}</th><th class="">${ssrInterpolate(unref(trans)("Service"))}</th><th class="">${ssrInterpolate(unref(trans)("Category"))}</th><th class="">${ssrInterpolate(unref(trans)("Created Date"))}</th><th class="">${ssrInterpolate(unref(trans)("Status"))}</th><th><div class="text-right">${ssrInterpolate(unref(trans)("Action"))}</div></th></tr></thead>`);
      if (__props.jobs.total > 0) {
        _push(`<tbody><!--[-->`);
        ssrRenderList(__props.jobs.data, (job) => {
          var _a2;
          _push(`<tr><td class="text-left">${ssrInterpolate(job.title)}</td><td class="text-left"><img${ssrRenderAttrs(mergeProps({
            class: "mr-2 inline w-10 rounded-full",
            alt: "avatar"
          }, ssrGetDirectiveProps(
            _ctx,
            _directive_lazy,
            job.user.avatar == null ? `https://ui-avatars.com/api/?name=${job.user.name}` : `${job.user.avatar}`
          )))}> ${ssrInterpolate(job.user.name)}</td><td class="text-left">${ssrInterpolate(job.service.title)}</td><td class="text-left">${ssrInterpolate((_a2 = job.categories[0]) == null ? void 0 : _a2.title)}</td><td>${ssrInterpolate(unref(moment)(job.created_at).format("D-MMM-Y"))}</td><td class="text-left"><span class="${ssrRenderClass([job.status == 1 ? "badge-success" : "badge-danger", "badge"])}">${ssrInterpolate(job.status == 1 ? unref(trans)("Active") : unref(trans)("Inactive"))}</span></td><td><div class="flex justify-end"><div class="dropdown" data-placement="bottom-end"><div class="dropdown-toggle"><i class="w-6 text-slate-400" data-feather="more-horizontal"></i></div><div class="dropdown-content w-40"><ul class="dropdown-list"><li class="dropdown-list-item"><button class="dropdown-link"><i class="h-5 text-slate-400" data-feather="edit"></i><span>${ssrInterpolate(unref(trans)("Edit"))}</span></button></li><li class="dropdown-list-item">`);
          _push(ssrRenderComponent(_component_Link, {
            href: _ctx.route("admin.job.show", job.id),
            class: "dropdown-link"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
          ...
          _push(`</li><li class="dropdown-list-item"><button as="button" class="dropdown-link"><i class="h-5 text-slate-400" data-feather="trash-2"></i><span>${ssrInterpolate(unref(trans)("Delete"))}</span></button></li></ul></div></div></div></td></tr>`);
        });
        _push(`<!--]--></tbody>`);
      } else {
        _push(ssrRenderComponent(_sfc_main$2A, { "for-table": "true" }, null, _parent));
...
_sfc_main$1X.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Job/Index.vue");
...
const __default__$1u = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1W = /* @__PURE__ */ Object.assign(__default__$1u, {
  __name: "Show",
  __ssrInlineRender: true,
  props: ["job", "buttons", "segments"],
  setup(__props) {
    const props = __props;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="space-y-6"><div class="grid grid-cols-1 gap-6 lg:grid-cols-4"><section class="col-span-1 flex h-min w-full flex-col gap-6 lg:sticky lg:top-20"><div class="card"><div class="card-body flex flex-col gap-y-3"><div class="relative my-2 h-16 w-16"><img${ssrRenderAttrs(mergeProps({
        alt: " avatar-img",
        class: "h-full w-full rounded-full"
      }, ssrGetDirectiveProps(
        _ctx,
        _directive_lazy,
        __props.job.user.avatar == null ? `https://ui-avatars.com/api/?name=${__props.job.user.name}` : `${__props.job.user.avatar}`
      )))}></div><div>`);
      _push(ssrRenderComponent(_component_Link, {
        href: _ctx.route("admin.companies.show", __props.job.user.id),
        class: "mb-1 block font-medium text-slate-700 dark:text-slate-200"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(__props.job.user.name)}`);
          } else {
            return [
              createTextVNode(toDisplayString(__props.job.user.name), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<span class="description">${ssrInterpolate(_ctx.trans("Status"))}: </span><span class="${ssrRenderClass([__props.job.status == 1 ? "badge-success" : "badge-danger", "badge badge-sm"])}">${ssrInterpolate(__props.job.status == 1 ? _ctx.trans("Active") : _ctx.trans("Inactive"))}</span></div><div><h5>${ssrInterpolate(_ctx.trans("Overview"))}</h5><div>${ssrInterpolate(__props.job.user.meta.business.description)}</div></div><div>${ssrInterpolate(_ctx.trans("Join Date: "))} ${ssrInterpolate(__props.job.user.created_at_date)}</div><div><h5>${ssrInterpolate(_ctx.trans("Socials"))}</h5><ul class="flex flex-wrap gap-x-4"><!--[-->`);
      ssrRenderList(socials.value, (social, key) => {
        _push(`<li class="capitalize">`);
        if (social) {
          _push(`<a${ssrRenderAttr("href", social)} target="_blank" class="hover:underline"><span>${ssrInterpolate(key)}</span></a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</li>`);
      ...
      _push(`<!--]--></ul></div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Service"))}</span><div>${ssrInterpolate((_a2 = __props.job.service) == null ? void 0 : _a2.title)}</div></div><div><h6>${ssrInterpolate(_ctx.trans("Categories"))}</h6><ul class="ml-5"><!--[-->`);
      ssrRenderList(__props.job.categories, (cat) => {
        _push(`<li class="list-disc">${ssrInterpolate(cat.title)}</li>`);
      });
      _push(`<!--]--></ul></div><div class="grid grid-cols-4 gap-y-6"><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Salary"))}</span><div>${ssrInterpolate(__props.job.salary_range)}/${ssrInterpolate(__props.job.salary_type.charAt(0).toLowerCase())}</div></div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Expertise"))}</span><div>${ssrInterpolate(__props.job.expertise)}</div></div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Location"))}</span>`);
      if (JSON.parse(__props.job.meta).is_remote) {
        _push(`<div>${ssrInterpolate(_ctx.trans("Remote"))}</div>`);
      } else {
        _push(`<div>${ssrInterpolate((_b2 = __props.job.country[0]) == null ? void 0 : _b2.name)},${ssrInterpolate((_c = __props.job.state[0]) == null ? void 0 : _c.name)}</div>`);
      }
      _push(`</div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Job Type"))}</span><div>${ssrInterpolate(__props.job.type)}</div></div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Date"))}</span><div>${ssrInterpolate(unref(moment)(__props.job.updated_at).format("D MMM, YYYY"))}</div></div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Experience"))}</span><div>${ssrInterpolate(__props.job.experience)}</div></div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Apply Type"))}</span><div>${ssrInterpolate(__props.job.apply_type == 1 ? "Email" : __props.job.apply_type == 2 ? "External" : "Default")}</div></div><div><span class="font-semibold">${ssrInterpolate(_ctx.trans("Expired Date"))}</span><div>${ssrInterpolate(__props.job.expired_at ? unref(moment)(__props.job.expired_at).format("D MMM, YYYY") : "None")}</div></div></div><div><h6>${ssrInterpolate(_ctx.trans("Custom fields"))}</h6>`);
      if (((_d = JSON.parse(__props.job.fields)) == null ? void 0 : _d.length) > 0) {
        _push(`<div class="mt-1 grid grid-cols-3"><!--[-->`);
        ssrRenderList(JSON.parse(__props.job.fields), (field, i) => {
          _push(`<div><span>${ssrInterpolate(_ctx.trans("Label"))}: ${ssrInterpolate(field.label)}</span> <br><span>${ssrInterpolate(_ctx.trans("Type"))}: ${ssrInterpolate(field.type)}</span></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></div></div></section></div></div></main>`);
    };
  }
});
...
_sfc_main$1W.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Job/Show.vue");
...
const __default__$1t = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1V = /* @__PURE__ */ Object.assign(__default__$1t, {
  __name: "Create",
  __ssrInlineRender: true,
...
const __default__$1s = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1U = /* @__PURE__ */ Object.assign(__default__$1s, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$1r = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1T = /* @__PURE__ */ Object.assign(__default__$1r, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "kycMethods",
...
const __default__$1q = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1S = /* @__PURE__ */ Object.assign(__default__$1q, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "requests",
...
const __default__$1p = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1R = /* @__PURE__ */ Object.assign(__default__$1p, {
  __name: "Show",
  __ssrInlineRender: true,
...
const __default__$1o = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1Q = /* @__PURE__ */ Object.assign(__default__$1o, {
  __name: "Index",
  __ssrInlineRender: true,
...
const __default__$1n = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1P = /* @__PURE__ */ Object.assign(__default__$1n, {
  __name: "Show",
  __ssrInlineRender: true,
  props: ["posts", "id", "buttons", "segments"],
  setup(__props) {
...
const __default__$1m = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1O = /* @__PURE__ */ Object.assign(__default__$1m, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "segments",
...
const __default__$1l = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1N = /* @__PURE__ */ Object.assign(__default__$1l, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "histories",
...
const __default__$1k = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1M = /* @__PURE__ */ Object.assign(__default__$1k, {
  __name: "Show",
  __ssrInlineRender: true,
...
const __default__$1j = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1L = /* @__PURE__ */ Object.assign(__default__$1j, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "menus",
...
const NestedDraggable = /* @__PURE__ */ _export_sfc(_sfc_main$1K, [["__scopeId", "data-v-dd242e89"]]);
const __default__$1i = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1J = /* @__PURE__ */ Object.assign(__default__$1i, {
  __name: "Show",
  __ssrInlineRender: true,
...
const __default__$1h = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1I = /* @__PURE__ */ Object.assign(__default__$1h, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "segments",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "container flex-grow p-4 sm:p-6" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$2O, {
        title: unref(trans)("Conversation Delete Requests"),
        segments: __props.segments,
        buttons: __props.buttons
      }, null, _parent));
      _push(`<div class="space-y-6">`);
      _push(ssrRenderComponent(_sfc_main$2B, {
        items: conversationStats,
        grid: "1"
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$2v, { options: filterOptions }, null, _parent));
      _push(`<div class="table-responsive whitespace-nowrap rounded-primary"><table class="table"><thead><tr><th>${ssrInterpolate(unref(trans)("Employer"))}</th><th>${ssrInterpolate(unref(trans)("Candidate"))}</th><th class="text-left">${ssrInterpolate(unref(trans)("Created At"))}</th><th class="text-left">${ssrInterpolate(unref(trans)("Replies"))}</th><th class="flex justify-end">${ssrInterpolate(unref(trans)("Action"))}</th></tr></thead>`);
      if (__props.conversations.total) {
        _push(`<tbody class="list"><!--[-->`);
        ssrRenderList(__props.conversations.data, (conversation) => {
          _push(`<tr><td><!--[-->`);
          ssrRenderList(conversation.users, (user) => {
            _push(`<div class="flex items-center gap-3">`);
            if (user.role === "employer") {
              _push(ssrRenderComponent(_component_Link, {
                href: _ctx.route("admin.companies.show", user.id)
              }, {
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    _push2(`<div class="avatar avatar-circle"${_scopeId}><img${ssrRenderAttrs(mergeProps({ class: "avatar-img" }, ssrGetDirectiveProps(
                      _ctx,
                      _directive_lazy,
                      user.avatar == null ? `https://ui-avatars.com/api/?name=${user.name}` : user.avatar
                    )))}${_scopeId}></div>`);
                  } else {
                    return [
                      createVNode("div", { class: "avatar avatar-circle" }, [
                        withDirectives(createVNode("img", { class: "avatar-img" }, null, 512), [
                          [
                            _directive_lazy,
                            user.avatar == null ? `https://ui-avatars.com/api/?name=${user.name}` : user.avatar
                          ]
          ...
          ssrRenderList(conversation.users, (user) => {
            ...
            if (user.role === "user") {
              _push(ssrRenderComponent(_component_Link, {
                href: _ctx.route("admin.candidates.show", user.id)
              }, {
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    _push2(`<div class="avatar avatar-circle"${_scopeId}><img${ssrRenderAttrs(mergeProps({ class: "avatar-img" }, ssrGetDirectiveProps(
          ...
          _push(`<!--]--></td><td class="text-center">${ssrInterpolate(unref(moment)(conversation.created_at).format("D MMM, YYYY"))}</td><td class="text-center">${ssrInterpolate(conversation.replies_count)}</td><td><div class="dropdown" data-placement="bottom-start"><div class="dropdown-toggle"><i class="w-6 text-slate-400" data-feather="more-horizontal"></i></div><div class="dropdown-content w-40"><ul class="dropdown-list"><li class="dropdown-list-item">`);
          _push(ssrRenderComponent(_component_Link, {
            href: _ctx.route("admin.message.show", conversation.uuid),
            class: "dropdown-link"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
          ...
          _push(`</li><li class="dropdown-list-item"><button class="dropdown-link"><i class="h-5 text-slate-400" data-feather="trash"></i> ${ssrInterpolate(unref(trans)("Delete"))}</button></li></ul></div></div></td></tr>`);
        });
        _push(`<!--]--></tbody>`);
      } else {
        _push(ssrRenderComponent(_sfc_main$2A, { "for-table": "true" }, null, _parent));
...
_sfc_main$1I.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Message/Index.vue");
...
const __default__$1g = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1H = /* @__PURE__ */ Object.assign(__default__$1g, {
  __name: "Show",
  __ssrInlineRender: true,
  props: [
    "segments",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="table-responsive whitespace-nowrap rounded-primary"><table class="table"><thead><tr><th>${ssrInterpolate(unref(trans)("Name"))}</th><th>${ssrInterpolate(unref(trans)("Email"))}</th><th class="text-left">${ssrInterpolate(unref(trans)("Message"))}</th><th class="text-left">${ssrInterpolate(unref(trans)("Attachments"))}</th><th class="text-left">${ssrInterpolate(unref(trans)("Date"))}</th></tr></thead>`);
      if (__props.replies.total != 0) {
        _push(`<tbody class="list"><!--[-->`);
        ssrRenderList(__props.replies.data, (reply) => {
          _push(`<tr><td><div class="flex items-center gap-3"><div class="avatar avatar-circle"><img${ssrRenderAttrs(mergeProps({ class: "avatar-img" }, ssrGetDirectiveProps(
            _ctx,
            _directive_lazy,
            reply.user.avatar == null ? `https://ui-avatars.com/api/?name=${reply.user.name}` : reply.user.avatar
          )))}></div> ${ssrInterpolate(reply.user.name)}</div></td><td>${ssrInterpolate(reply.user.email)}</td><td>${ssrInterpolate(unref(textExcerpt)(reply.body, 40))}</td><td>`);
          if (reply.attachments) {
            _push(`<!--[-->`);
            ssrRenderList(JSON.parse(reply.attachments), (att, i) => {
              _push(`<a${ssrRenderAttr("href", att)} class="mb-1 block" download><div class="file-name">${ssrInterpolate(unref(textExcerpt)(att, 25))}</div></a>`);
            });
            _push(`<!--]-->`);
          } else {
            _push(`<span>None</span>`);
          }
          _push(`</td><td class="text-center">${ssrInterpolate(unref(moment)(reply.created_at).format("D MMM, YYYY h:m a"))}</td></tr>`);
        });
        _push(`<!--]--></tbody>`);
      } else {
        _push(`<!---->`);
      ...
      _push(`</table>`);
      _push(ssrRenderComponent(_sfc_main$2w, {
        links: __props.replies.links
      }, null, _parent));
      if (__props.replies.total == 0) {
        _push(ssrRenderComponent(_sfc_main$2D, {
          type: "info",
          text: unref(trans)("Opps do not have any replies....")
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
...
_sfc_main$1H.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Message/Show.vue");
...
const __default__$1f = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1G = /* @__PURE__ */ Object.assign(__default__$1f, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "segments",
...
const __default__$1e = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1F = /* @__PURE__ */ Object.assign(__default__$1e, {
  __name: "Show",
  __ssrInlineRender: true,
  props: [
    "order",
...
const __default__$1d = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1E = /* @__PURE__ */ Object.assign(__default__$1d, {
  __name: "Create",
  __ssrInlineRender: true,
  props: ["buttons", "segments"],
  setup(__props) {
...
const __default__$1c = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1D = /* @__PURE__ */ Object.assign(__default__$1c, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$1b = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1C = /* @__PURE__ */ Object.assign(__default__$1b, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "pages",
...
const __default__$1a = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1B = /* @__PURE__ */ Object.assign(__default__$1a, {
  __name: "About",
  __ssrInlineRender: true,
  props: ["data"],
  setup(__props) {
...
const _sfc_main$1A = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<form${ssrRenderAttrs(_attrs)}><h6>${ssrInterpolate(_ctx.trans("Auth Page Contents"))}</h6><div class="p-3 mt-2 mb-10 bg-opacity-50 border rounded bg-slate-50 dark:bg-slate-800 dark:border-slate-500"><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Email"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.email)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Phone"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.phone)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Office Address"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.address)}></div></div><div class="mb-2">`);
      _push(ssrRenderComponent(_sfc_main$2F, {
        processing: unref(form).processing,
        "btn-text": _ctx.trans("Save Changes")
      }, null, _parent));
...
_sfc_main$1A.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/PageSetting/Auth.vue");
...
const _sfc_main$1z = {
  ...
  setup(__props) {
    const form = useOptionUpdateStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<form${ssrRenderAttrs(_attrs)}><h6>${ssrInterpolate(_ctx.trans("Contact Page Contents"))}</h6><div class="p-3 mt-2 mb-10 bg-opacity-50 border rounded bg-slate-50 dark:bg-slate-800 dark:border-slate-500"><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Page Title"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.page_title)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Section Top Title"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.top_title)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Section Title"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.title)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Section Description"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.description)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Section Email"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.email)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Section Phone"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.phone)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Section Office Address"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.address)}></div></div><div class="mb-2">`);
      _push(ssrRenderComponent(_sfc_main$2F, {
        processing: unref(form).processing,
        "btn-text": _ctx.trans("Save Changes")
      }, null, _parent));
...
_sfc_main$1z.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/PageSetting/Contact.vue");
  return _sfc_setup$1z ? _sfc_setup$1z(props, ctx) : void 0;
};
...
const _sfc_main$1x = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<form${ssrRenderAttrs(_attrs)}><h6>${ssrInterpolate(_ctx.trans("Primary Settings"))}</h6><div class="p-3 mt-2 mb-10 bg-opacity-50 border rounded bg-slate-50 dark:bg-slate-800 dark:border-slate-500"><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("TopBar Left text"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.top_bar.left_text)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("TopBar Email"))}</label><input type="email" class="input"${ssrRenderAttr("value", __props.data.top_bar.email)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("TopBar Right text"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.top_bar.right_text)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Site Logo (Deep)"))}</label><input type="file" accept="image/*" class="input"></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Site Logo (light)"))}</label><input type="file" accept="image/*" class="input"></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Favicon"))}</label><input type="file" accept="image/*" class="input"></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Footer Description"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.footer_description)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Copyright text"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.copyright_text)}></div></div><h6>${ssrInterpolate(_ctx.trans("Social Networks"))}</h6><div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600"><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Facebook Profile Link"))}</label><input type="url" class="input"${ssrRenderAttr("value", __props.data.socials.facebook)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Youtube Profile Link"))}</label><input type="url" class="input"${ssrRenderAttr("value", __props.data.socials.youtube)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Twitter Profile Link"))}</label><input type="url" class="input"${ssrRenderAttr("value", __props.data.socials.twitter)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Instagram Profile Link"))}</label><input type="url" class="input"${ssrRenderAttr("value", __props.data.socials.instagram)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Linkedin Profile Link"))}</label><input type="url" class="input"${ssrRenderAttr("value", __props.data.socials.linkedin)}></div></div><h6>${ssrInterpolate(_ctx.trans("About Section Card"))}</h6><div class="p-3 mt-2 mb-10 bg-opacity-50 border rounded bg-slate-50 dark:bg-slate-800 dark:border-slate-500"><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Top title"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.about_section.top_title)}></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Title"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.about_section.title)}><i>${ssrInterpolate(_ctx.trans("use {text} to highlight"))}</i></div><div class="mb-2"><label>${ssrInterpolate(_ctx.trans("Text content"))}</label><input type="text" class="input"${ssrRenderAttr("value", __props.data.about_section.text)}></div><div class="mb-2"><label class="mr-2">${ssrInterpolate(_ctx.trans("Category list"))}</label><!--[-->`);
...
const __default__$19 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1w = /* @__PURE__ */ Object.assign(__default__$19, {
  __name: "Index",
  __ssrInlineRender: true,
  props: ["primary_data", "home_page", "about_page", "contact_page", "auth_page"],
  setup(__props) {
    onMounted(() => {
      tabs.init();
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "container flex-grow p-4 sm:p-6" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$2O, null, null, _parent));
      _push(`<div class="space-y-6"><div class="card"><div class="card-body"><div class="tabs tabs-vertical"><ul class="tabs-list w-72"><li class="tabs-item"><button class="tabs-btn active" data-panel-id="#primary" type="button"><span>${ssrInterpolate(_ctx.trans("Primary"))}</span></button></li><li class="tabs-item"><button class="tabs-btn" data-panel-id="#home" type="button"><span>${ssrInterpolate(_ctx.trans("Home Page"))}</span></button></li><li class="tabs-item"><button class="tabs-btn" data-panel-id="#about" type="button"><span>${ssrInterpolate(_ctx.trans("About Page"))}</span></button></li><li class="tabs-item"><button class="tabs-btn" data-panel-id="#contact" type="button"><span>${ssrInterpolate(_ctx.trans("Contact Page"))}</span></button></li><li class="tabs-item"><button class="tabs-btn" data-panel-id="#auth" type="button"><span>${ssrInterpolate(_ctx.trans("Auth Pages"))}</span></button></li></ul><div class="tabs-content"><div class="tabs-panel active" id="primary">`);
      _push(ssrRenderComponent(_sfc_main$1x, { data: __props.primary_data }, null, _parent));
      _push(`</div><div class="tabs-panel" id="home">`);
      _push(ssrRenderComponent(_sfc_main$1y, { data: __props.home_page }, null, _parent));
      _push(`</div><div class="tabs-panel" id="about">`);
      _push(ssrRenderComponent(_sfc_main$1B, { data: __props.about_page }, null, _parent));
      _push(`</div><div class="tabs-panel" id="contact">`);
      _push(ssrRenderComponent(_sfc_main$1z, { data: __props.contact_page }, null, _parent));
      _push(`</div><div class="tabs-panel" id="auth">`);
      _push(ssrRenderComponent(_sfc_main$1A, { data: __props.auth_page }, null, _parent));
...
const __default__$18 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1v = /* @__PURE__ */ Object.assign(__default__$18, {
  __name: "Create",
  __ssrInlineRender: true,
  props: ["segments", "buttons"],
  setup(__props) {
...
const __default__$17 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1u = /* @__PURE__ */ Object.assign(__default__$17, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$16 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1t = /* @__PURE__ */ Object.assign(__default__$16, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "methods",
...
const __default__$15 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1s = /* @__PURE__ */ Object.assign(__default__$15, {
  __name: "Index",
  __ssrInlineRender: true,
...
const __default__$14 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1r = /* @__PURE__ */ Object.assign(__default__$14, {
  __name: "Show",
  __ssrInlineRender: true,
...
const __default__$13 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1q = /* @__PURE__ */ Object.assign(__default__$13, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$12 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1p = /* @__PURE__ */ Object.assign(__default__$12, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "categories",
...
const __default__$11 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1o = /* @__PURE__ */ Object.assign(__default__$11, {
  __name: "Create",
  __ssrInlineRender: true,
...
const __default__$10 = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1n = /* @__PURE__ */ Object.assign(__default__$10, {
  __name: "Edit",
  __ssrInlineRender: true,
...
const __default__$$ = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1m = /* @__PURE__ */ Object.assign(__default__$$, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "projects",
...
const __default__$_ = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1l = /* @__PURE__ */ Object.assign(__default__$_, {
  __name: "Create",
  __ssrInlineRender: true,
...
const __default__$Z = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1k = /* @__PURE__ */ Object.assign(__default__$Z, {
  __name: "Edit",
  __ssrInlineRender: true,
  props: [
    "segments",
...
const __default__$Y = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1j = /* @__PURE__ */ Object.assign(__default__$Y, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "project",
...
const __default__$X = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1i = /* @__PURE__ */ Object.assign(__default__$X, {
  __name: "Commissions",
  __ssrInlineRender: true,
  props: [
    "commissions",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="space-y-6">`);
      _push(ssrRenderComponent(_sfc_main$2B, { items: stats }, null, _parent));
...
const __default__$W = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1h = /* @__PURE__ */ Object.assign(__default__$W, {
  __name: "History",
  __ssrInlineRender: true,
...
const __default__$V = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1g = /* @__PURE__ */ Object.assign(__default__$V, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "returnTransactions",
...
const __default__$U = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1f = /* @__PURE__ */ Object.assign(__default__$U, {
  __name: "Create",
  __ssrInlineRender: true,
...
const _sfc_main$1e = /* @__PURE__ */ Object.assign(__default__$T, {
  __name: "Edit",
  __ssrInlineRender: true,
  props: ["segments", "buttons"],
  setup(__props) {
...
const __default__$S = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1d = /* @__PURE__ */ Object.assign(__default__$S, {
  __name: "Index",
  __ssrInlineRender: true,
  props: ["segments", "buttons", "roles"],
  setup(__props) {
...
const _sfc_main$1c = /* @__PURE__ */ Object.assign(__default__$R, {
  __name: "Index",
  __ssrInlineRender: true,
...
const _sfc_main$1b = /* @__PURE__ */ Object.assign(__default__$Q, {
  __name: "Show",
  __ssrInlineRender: true,
  props: ["id", "seo"],
  setup(__props) {
...
const __default__$P = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$1a = /* @__PURE__ */ Object.assign(__default__$P, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "segments",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="space-y-6">`);
      _push(ssrRenderComponent(_sfc_main$2B, { items: supportStats }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$2v, { options: filterOptions }, null, _parent));
...
const __default__$O = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$19 = /* @__PURE__ */ Object.assign(__default__$O, {
  __name: "Show",
  __ssrInlineRender: true,
...
const __default__$N = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$18 = /* @__PURE__ */ Object.assign(__default__$N, {
  __name: "Create",
  __ssrInlineRender: true,
  props: ["buttons", "segments"],
  setup(__props) {
...
const __default__$M = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$17 = /* @__PURE__ */ Object.assign(__default__$M, {
  __name: "Edit",
  __ssrInlineRender: true,
  props: ["buttons", "segments", "info", "socials"],
  setup(__props) {
...
const __default__$L = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$16 = /* @__PURE__ */ Object.assign(__default__$L, {
  __name: "Index",
  __ssrInlineRender: true,
  props: [
    "posts",
...
const __default__$K = defineComponent({ layout: _sfc_main$2H });
const _sfc_main$15 = /* @__PURE__ */ Object.assign(__default__$K, {
  __name: "Index",
  __ssrInlineRender: true,
...
const _sfc_main$14 = {
  __name: "AuthLeftSection",
  __ssrInlineRender: true,
  props: ["data"],
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<ul${ssrRenderAttrs(mergeProps({ class: "list-item space-y-6 pt-8" }, _attrs))}><li class="flex"><div class="mr-6 flex-none"><div class=""><img src="/assets/images/svg/mail.svg" alt="" class=""></div></div><div class="flex-1"><h4 class="mb-1 text-lg lg:text-xl">${ssrInterpolate(_ctx.trans("Email-Us"))} :</h4><div>${ssrInterpolate(__props.data.email)}</div></div></li><li class="flex"><div class="mr-6 flex-none"><div class=""><img src="/assets/images/svg/call.svg" alt="" class=""></div></div><div class="flex-1"><h4 class="mb-1 text-lg lg:text-xl">${ssrInterpolate(_ctx.trans("Call Us"))}:</h4><div>${ssrInterpolate(__props.data.phone)}</div></div></li><li class="flex"><div class="mr-6 flex-none"><div class=""><img src="/assets/images/svg/map.svg" alt="" class=""></div></div><div class="flex-1"><h4 class="mb-1 text-lg lg:text-xl">${ssrInterpolate(_ctx.trans("Office"))} :</h4><div>${ssrInterpolate(__props.data.address)}</div></div></li></ul>`);
    };
  }
};
...
_sfc_main$14.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/AuthLeftSection.vue");
...
const _sfc_main$10 = {
  ...
  setup(__props) {
    ...
    const topBar = usePage().props.primaryData["top_bar"] ?? {};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Link = resolveComponent("Link");
      const _directive_lazy = resolveDirective("lazy");
      _push(`<!--[--><header class="site-header"><div class="bg-primary hidden py-3 text-white md:block"><div class="container"><div class="grid grid-cols-1 gap-5 lg:grid-cols-2"><ul class="flex justify-center divide-x divide-white divide-opacity-25 text-base lg:justify-start"><li class="mr-4">${ssrInterpolate((_a2 = unref(topBar)) == null ? void 0 : _a2.left_text)}</li><li class="pl-4"><a${ssrRenderAttr("href", `mailto:${unref(topBar).email}`)}>${ssrInterpolate((_b2 = unref(topBar)) == null ? void 0 : _b2.email)}</a></li></ul><ul class="flex items-center justify-center divide-x divide-white divide-opacity-25 text-base lg:justify-end"><li class="px-2">${ssrInterpolate(unref(topBar).right_text)}:</li><!--[-->`);
      ssrRenderList(unref(socials), (link, platform) => {
        _push(`<li>`);
        if (link) {
          _push(`<a${ssrRenderAttr("href", link)} target="_blank" class="px-2 text-lg"><iconify-icon${ssrRenderAttr("icon", `bxl:${platform}`)}></iconify-icon></a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</li>`);
...
const _sfc_main$_ = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p>${ssrInterpolate((_b2 = (_a2 = _ctx.$page.props) == null ? void 0 : _a2.primaryData) == null ? void 0 : _b2.footer_description)}</p><ul class="flex space-x-4 pt-8"><!--[-->`);
      ssrRenderList(unref(socials), (social, key) => {
        _push(`<li>`);
        if (social) {
...
const _sfc_main$X = /* @__PURE__ */ Object.assign(__default__$J, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container my-20"><div class="grid grid-cols-12 gap-[30px]"><div class="col-span-12 lg:col-span-6 xl:col-span-5"><div class="mini-title">${ssrInterpolate(_ctx.trans("Confirm Password"))}</div><h4 class="column-title">${ssrInterpolate(_ctx.trans("Confirm"))} <span class="shape-bg">${ssrInterpolate(_ctx.trans("Password"))}</span></h4><div>${ssrInterpolate(_ctx.trans("Please confirm your password before continuing."))}</div>`);
      _push(ssrRenderComponent(_sfc_main$14, { data: __props.auth_page }, null, _parent));
      _push(`</div><div class="col-span-12 lg:col-span-6 xl:col-span-7"><form class="shadow-box7 mt-10 space-y-4 rounded-md border border-gray-100 bg-white p-8"><div><label>${ssrInterpolate(_ctx.trans("Password"))} *</label><input type="password" required${ssrRenderAttr("value", unref(form).password)} class="from-control" placeholder="Enter Password">`);
      _push(ssrRenderComponent(_sfc_main$2b, {
...
const _sfc_main$W = /* @__PURE__ */ Object.assign(__default__$I, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container my-20"><div class="grid grid-cols-12 gap-[30px]"><div class="col-span-12 lg:col-span-6 xl:col-span-5"><div class="mini-title">${ssrInterpolate(_ctx.trans("Forgot Password"))}</div><h4 class="column-title">${ssrInterpolate(_ctx.trans("Forgot"))} <span class="shape-bg">${ssrInterpolate(_ctx.trans("Password"))}</span></h4><div>${ssrInterpolate(_ctx.trans("Forgot your password? No problem, reset now"))}</div>`);
      _push(ssrRenderComponent(_sfc_main$14, { data: __props.auth_page }, null, _parent));
      _push(`</div><div class="col-span-12 lg:col-span-6 xl:col-span-7"><form class="shadow-box7 mt-10 space-y-4 rounded-md border border-gray-100 bg-white p-8">`);
      if (__props.status) {
...
const _sfc_main$V = /* @__PURE__ */ Object.assign(__default__$H, {
  __name: "Login",
  __ssrInlineRender: true,
  props: ["googleClient", "facebookClient", "auth_page"],
  setup(__props) {
    onMounted(() => window.scrollTo(0, 300));
    const form = useForm({
      email: "",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_sfc_main$14, { data: __props.auth_page }, null, _parent));
      _push(`</div><div class="col-span-12 lg:col-span-6 xl:col-span-7"><form class="shadow-box7 mt-10 w-full space-y-4 rounded-md border border-gray-100 bg-white p-8"><div><label>${ssrInterpolate(_ctx.trans("Email"))} *</label><input type="email" required${ssrRenderAttr("value", unref(form).email)} class="from-control" placeholder="Email">`);
      _push(ssrRenderComponent(_sfc_main$2b, {
        message: unref(form).errors.email
      }, null, _parent));
...
const _sfc_main$U = /* @__PURE__ */ Object.assign(__default__$G, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_sfc_main$14, { data: __props.auth_page }, null, _parent));
      _push(`</div><div class="col-span-12 lg:col-span-6 xl:col-span-7"><form class="p-8 mt-10 space-y-4 bg-white border border-gray-100 rounded-md shadow-box7"><div><label>${ssrInterpolate(_ctx.trans("Full Name"))}</label><input type="text" required${ssrRenderAttr("value", unref(form).name)} class="from-control" placeholder="Name">`);
      _push(ssrRenderComponent(_sfc_main$2b, {
...
const _sfc_main$T = /* @__PURE__ */ Object.assign(__default__$F, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container my-20"><div class="grid grid-cols-12 gap-[30px]"><div class="col-span-12 lg:col-span-6 xl:col-span-5"><div class="mini-title">${ssrInterpolate(_ctx.trans("Reset Password"))}</div><h4 class="column-title">${ssrInterpolate(_ctx.trans("Reset"))} <span class="shape-bg">${ssrInterpolate(_ctx.trans("Password"))}</span></h4><div>${ssrInterpolate(_ctx.trans("Reset your Password."))}</div>`);
      _push(ssrRenderComponent(_sfc_main$14, { data: __props.auth_page }, null, _parent));
      _push(`</div><div class="col-span-12 lg:col-span-6 xl:col-span-7"><form class="shadow-box7 mt-10 space-y-4 rounded-md border border-gray-100 bg-white p-8"><div class="mb-6 text-center"><h4>${ssrInterpolate(_ctx.trans("Reset Password"))}</h4></div><div><label>${ssrInterpolate(_ctx.trans("Email"))} *</label><input readonly type="email" required${ssrRenderAttr("value", unref(form).email)} class="from-control" placeholder="Enter your email here">`);
      _push(ssrRenderComponent(_sfc_main$2b, {
        message: unref(form).errors.email
      }, null, _parent));
...
const Affiliate_vue_vue_type_style_index_0_lang = "";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.commissions.data.length > 0) {
        ...
        _push(ssrRenderComponent(_sfc_main$2A, null, null, _parent));
      }
      _push(ssrRenderComponent(_sfc_main$2w, {
        links: __props.commissions.links
      }, null, _parent));
...
const _sfc_main$H = /* @__PURE__ */ Object.assign(__default__$x, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2v, { options: selectOptions }, null, _parent));
...
const _sfc_main$o = /* @__PURE__ */ Object.assign(__default__$f, {
  ...
  setup(__props) {
    ...
    const form = useForm({});
    const payableAmount = (multiply = 0, charge = 0) => {
      const amount = parseFloat(props.total) * parseFloat(multiply) + parseFloat(charge);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.gateways, (gateway) => {
        ...
        _push(`<tr><td>${ssrInterpolate(_ctx.trans("Payable Amount: "))}</td><td class="text-center">${ssrInterpolate(payableAmount(gateway.multiply, gateway.charge))}</td></tr></table>`);
...
const _sfc_main$e = /* @__PURE__ */ Object.assign(__default__$b, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Link = resolveComponent("Link");
      _push(`<!--[--><div class="breadcrumbs section-padding bg-[url(&#39;../images/all-img/bred.png&#39;)] bg-cover bg-center bg-no-repeat"><div class="container text-center"><h2>${ssrInterpolate(__props.contact_page.page_title)}</h2><nav><ol class="flex items-center justify-center space-x-3"><li class="breadcrumb-item">`);
      _push(ssrRenderComponent(_component_Link, { href: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</li><li class="breadcrumb-item">-</li><li class="text-primary">${ssrInterpolate(unref(trans)("Contact Us"))}</li></ol></nav></div></div><div class="nav-tab-wrapper tabs section-padding"><div class="container"><div class="grid grid-cols-12 gap-[30px]"><div class="col-span-12 lg:col-span-6 xl:col-span-5"><div class="mini-title">${ssrInterpolate(__props.contact_page.top_title)}</div><h4 class="column-title">${__props.contact_page.title}</h4><div>${ssrInterpolate(__props.contact_page.description)}</div><ul class="list-item space-y-6 pt-8"><li class="flex"><div class="mr-6 flex-none"><div class=""><img src="/assets/images/svg/mail.svg" alt="" class=""></div></div><div class="flex-1"><h4 class="mb-1 text-lg lg:text-xl">${ssrInterpolate(unref(trans)("Email-Us"))} :</h4><div>${ssrInterpolate(__props.contact_page.email)}</div></div></li><li class="flex"><div class="mr-6 flex-none"><div class=""><img src="/assets/images/svg/call.svg" alt="" class=""></div></div><div class="flex-1"><h4 class="mb-1 text-lg lg:text-xl">${ssrInterpolate(unref(trans)("Call Us"))}:</h4><div>${ssrInterpolate(__props.contact_page.phone)}</div></div></li><li class="flex"><div class="mr-6 flex-none"><div class=""><img src="/assets/images/svg/map.svg" alt="" class=""></div></div><div class="flex-1"><h4 class="mb-1 text-lg lg:text-xl">${ssrInterpolate(unref(trans)("Office"))} :</h4><div>${ssrInterpolate(__props.contact_page.address)}</div></div></li></ul></div><div class="col-span-12 lg:col-span-6 xl:col-span-7"><div class="shadow-box7 rounded-md bg-white p-8"><form><div class="mt-6 grid grid-cols-1 gap-[30px] md:grid-cols-2"><div><input type="text"${ssrRenderAttr("value", unref(form).name)} class="from-control" placeholder="Name*">`);
...
const _sfc_main$4 = /* @__PURE__ */ Object.assign(__default__$2, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><br><div class="payment-invoice"><div class="payment-border"><b>${ssrInterpolate(_ctx.trans("Invoiced To"))}</b><br> ${ssrInterpolate(__props.user.name)}<br> ${ssrInterpolate(__props.user.address)}</div><div class="payment-border"><b>${ssrInterpolate(_ctx.trans("Pay To"))}</b><br> ${ssrInterpolate(__props.invoice_data.company_name)} <br> ${ssrInterpolate(__props.invoice_data.address)}, ${ssrInterpolate(__props.invoice_data.city)} <br> ${ssrInterpolate(__props.invoice_data.post_code)}, ${ssrInterpolate(__props.invoice_data.country)}</div></div><div class="payment-details"><p class="mb-1 font-bold uppercase text-black">${ssrInterpolate(_ctx.trans("Invest Details"))}</p><table class="payment-table"><tr class="text-center"><td><b>${ssrInterpolate(_ctx.trans("Duration"))}</b></td><td><b>${ssrInterpolate(_ctx.trans("ROI"))}</b></td><td><b>${ssrInterpolate(_ctx.trans("Net Profit"))}</b></td><td><b>${ssrInterpolate(_ctx.trans("QTY"))}</b></td></tr><!--[-->`);
...
createInertiaApp({
  ...
  resolve: (name) => {
    const pages = /* @__PURE__ */ Object.assign({ "./Pages/Admin/Admin/Create.vue": __vite_glob_0_0, "./Pages/Admin/Admin/Edit.vue": __vite_glob_0_1, "./Pages/Admin/Admin/Index.vue": __vite_glob_0_2, "./Pages/Admin/Blogs/Categories/Index.vue": __vite_glob_0_3, "./Pages/Admin/Blogs/Create.vue": __vite_glob_0_4, "./Pages/Admin/Blogs/Edit.vue": __vite_glob_0_5, "./Pages/Admin/Blogs/Index.vue": __vite_glob_0_6, "./Pages/Admin/Blogs/Tags/Index.vue": __vite_glob_0_7, "./Pages/Admin/Brand/Index.vue": __vite_glob_0_8, "./Pages/Admin/Cron/Index.vue": __vite_glob_0_9, "./Pages/Admin/Currency/Index.vue": __vite_glob_0_10, "./Pages/Admin/Currency/Show.vue": __vite_glob_0_11, "./Pages/Admin/Customers/Index.vue": __vite_glob_0_12, "./Pages/Admin/Customers/Show.vue": __vite_glob_0_13, "./Pages/Admin/Dashboard.vue": __vite_glob_0_14, "./Pages/Admin/Developer/App.vue": __vite_glob_0_15, "./Pages/Admin/Developer/Cookie.vue": __vite_glob_0_16, "./Pages/Admin/Developer/Features.vue": __vite_glob_0_17, "./Pages/Admin/Developer/Newsletter.vue": __vite_glob_0_18, "./Pages/Admin/Developer/Smtp.vue": __vite_glob_0_19, "./Pages/Admin/Developer/SocialLogin.vue": __vite_glob_0_20, "./Pages/Admin/Developer/Storage.vue": __vite_glob_0_21, "./Pages/Admin/EventOrder/Index.vue": __vite_glob_0_22, "./Pages/Admin/EventOrder/Show.vue": __vite_glob_0_23, "./Pages/Admin/Events/Create.vue": __vite_glob_0_24, "./Pages/Admin/Events/Edit.vue": __vite_glob_0_25, "./Pages/Admin/Events/Index.vue": __vite_glob_0_26, "./Pages/Admin/Events/Participants.vue": __vite_glob_0_27, "./Pages/Admin/Faq/Index.vue": __vite_glob_0_28, "./Pages/Admin/Feature/Create.vue": __vite_glob_0_29, "./Pages/Admin/Feature/Edit.vue": __vite_glob_0_30, "./Pages/Admin/Feature/Index.vue": __vite_glob_0_31, "./Pages/Admin/Gateway/Create.vue": __vite_glob_0_32, "./Pages/Admin/Gateway/Edit.vue": __vite_glob_0_33, "./Pages/Admin/Gateway/Index.vue": __vite_glob_0_34, "./Pages/Admin/Invest/Index.vue": __vite_glob_0_35, "./Pages/Admin/Investors/Create.vue": __vite_glob_0_36, "./Pages/Admin/Investors/Edit.vue": __vite_glob_0_37, "./Pages/Admin/Investors/Index.vue": __vite_glob_0_38, "./Pages/Admin/Job/Index.vue": __vite_glob_0_39, "./Pages/Admin/Job/Show.vue": __vite_glob_0_40, "./Pages/Admin/KYC/Methods/Create.vue": __vite_glob_0_41, "./Pages/Admin/KYC/Methods/Edit.vue": __vite_glob_0_42, "./Pages/Admin/KYC/Methods/Index.vue": __vite_glob_0_43, "./Pages/Admin/KYC/Requests/Index.vue": __vite_glob_0_44, "./Pages/Admin/KYC/Requests/Show.vue": __vite_glob_0_45, "./Pages/Admin/Language/Index.vue": __vite_glob_0_46, "./Pages/Admin/Language/Show.vue": __vite_glob_0_47, "./Pages/Admin/Logs/Notification/Index.vue": __vite_glob_0_48, "./Pages/Admin/Logs/WalletTransactions/Index.vue": __vite_glob_0_49, "./Pages/Admin/Logs/WalletTransactions/Show.vue": __vite_glob_0_50, "./Pages/Admin/Menu/Index.vue": __vite_glob_0_51, "./Pages/Admin/Menu/Show.vue": __vite_glob_0_52, "./Pages/Admin/Message/Index.vue": __vite_glob_0_53, "./Pages/Admin/Message/Show.vue": __vite_glob_0_54, "./Pages/Admin/Order/Index.vue": __vite_glob_0_55, "./Pages/Admin/Order/Show.vue": __vite_glob_0_56, "./Pages/Admin/Page/Create.vue": __vite_glob_0_57, "./Pages/Admin/Page/Edit.vue": __vite_glob_0_58, "./Pages/Admin/Page/Index.vue": __vite_glob_0_59, "./Pages/Admin/PageSetting/About.vue": __vite_glob_0_60, "./Pages/Admin/PageSetting/Auth.vue": __vite_glob_0_61, "./Pages/Admin/PageSetting/Contact.vue": __vite_glob_0_62, "./Pages/Admin/PageSetting/Home.vue": __vite_glob_0_63, "./Pages/Admin/PageSetting/Index.vue": __vite_glob_0_64, "./Pages/Admin/PageSetting/Primary.vue": __vite_glob_0_65, "./Pages/Admin/PayoutMethod/Create.vue": __vite_glob_0_66, "./Pages/Admin/PayoutMethod/Edit.vue": __vite_glob_0_67, "./Pages/Admin/PayoutMethod/Index.vue": __vite_glob_0_68, "./Pages/Admin/Payouts/Index.vue": __vite_glob_0_69, "./Pages/Admin/Payouts/Show.vue": __vite_glob_0_70, "./Pages/Admin/Profile/Edit.vue": __vite_glob_0_71, "./Pages/Admin/ProjectCategories/Index.vue": __vite_glob_0_72, "./Pages/Admin/Projects/Create.vue": __vite_glob_0_73, "./Pages/Admin/Projects/Edit.vue": __vite_glob_0_74, "./Pages/Admin/Projects/Index.vue": __vite_glob_0_75, "./Pages/Admin/Projects/ReturnSchedules/Create.vue": __vite_glob_0_76, "./Pages/Admin/Projects/ReturnSchedules/Edit.vue": __vite_glob_0_77, "./Pages/Admin/Projects/ReturnSchedules/Index.vue": __vite_glob_0_78, "./Pages/Admin/Referrals/Commissions.vue": __vite_glob_0_79, "./Pages/Admin/Referrals/History.vue": __vite_glob_0_80, "./Pages/Admin/ReturnTransaction/Index.vue": __vite_glob_0_81, "./Pages/Admin/Role/Create.vue": __vite_glob_0_82, "./Pages/Admin/Role/Edit.vue": __vite_glob_0_83, "./Pages/Admin/Role/Index.vue": __vite_glob_0_84, "./Pages/Admin/Seo/Index.vue": __vite_glob_0_85, "./Pages/Admin/Seo/Show.vue": __vite_glob_0_86, "./Pages/Admin/Support/Index.vue": __vite_glob_0_87, "./Pages/Admin/Support/Show.vue": __vite_glob_0_88, "./Pages/Admin/Team/Create.vue": __vite_glob_0_89, "./Pages/Admin/Team/Edit.vue": __vite_glob_0_90, "./Pages/Admin/Team/Index.vue": __vite_glob_0_91, "./Pages/Admin/Testimonial/Index.vue": __vite_glob_0_92, "./Pages/Auth/ConfirmPassword.vue": __vite_glob_0_93, "./Pages/Auth/ForgotPassword.vue": __vite_glob_0_94, "./Pages/Auth/Login.vue": __vite_glob_0_95, "./Pages/Auth/Register.vue": __vite_glob_0_96, "./Pages/Auth/ResetPassword.vue": __vite_glob_0_97, "./Pages/Auth/VerifyEmail.vue": __vite_glob_0_98, "./Pages/User/AccountSettings.vue": __vite_glob_0_99, "./Pages/User/Affiliate.vue": __vite_glob_0_100, "./Pages/User/ChangePassword.vue": __vite_glob_0_101, "./Pages/User/Dashboard.vue": __vite_glob_0_102, "./Pages/User/EventOrder/Index.vue": __vite_glob_0_103, "./Pages/User/EventOrder/Show.vue": __vite_glob_0_104, "./Pages/User/Investments/Index.vue": __vite_glob_0_105, "./Pages/User/Investments/Show.vue": __vite_glob_0_106, "./Pages/User/KYC/Create.vue": __vite_glob_0_107, "./Pages/User/KYC/Index.vue": __vite_glob_0_108, "./Pages/User/KYC/ReSubmit.vue": __vite_glob_0_109, "./Pages/User/KYC/Show.vue": __vite_glob_0_110, "./Pages/User/Payout/Confirmation.vue": __vite_glob_0_111, "./Pages/User/Payout/Edit.vue": __vite_glob_0_112, "./Pages/User/Payout/Index.vue": __vite_glob_0_113, "./Pages/User/Payout/Invoice.vue": __vite_glob_0_114, "./Pages/User/Payout/Requests.vue": __vite_glob_0_115, "./Pages/User/Payout/Show.vue": __vite_glob_0_116, "./Pages/User/ProfitReturn/Index.vue": __vite_glob_0_117, "./Pages/User/Projects/Index.vue": __vite_glob_0_118, "./Pages/User/Support/Create.vue": __vite_glob_0_119, "./Pages/User/Support/Index.vue": __vite_glob_0_120, "./Pages/User/Support/Show.vue": __vite_glob_0_121, "./Pages/User/Wallet/Index.vue": __vite_glob_0_122, "./Pages/User/Wallet/Payment.vue": __vite_glob_0_123, "./Pages/Web/About.vue": __vite_glob_0_124, "./Pages/Web/Blogs/Inc/Sidebar.vue": __vite_glob_0_125, "./Pages/Web/Blogs/Index.vue": __vite_glob_0_126, "./Pages/Web/Blogs/Show.vue": __vite_glob_0_127, "./Pages/Web/Contact.vue": __vite_glob_0_128, "./Pages/Web/CustomPage.vue": __vite_glob_0_129, "./Pages/Web/Events/Book.vue": __vite_glob_0_130, "./Pages/Web/Events/BookSuccess.vue": __vite_glob_0_131, "./Pages/Web/Events/Index.vue": __vite_glob_0_132, "./Pages/Web/Events/Payment.vue": __vite_glob_0_133, "./Pages/Web/Events/Show.vue": __vite_glob_0_134, "./Pages/Web/Home.vue": __vite_glob_0_135, "./Pages/Web/Investors/Index.vue": __vite_glob_0_136, "./Pages/Web/Partials/AboutSection.vue": __vite_glob_0_137, "./Pages/Web/Partials/AchievementSection.vue": __vite_glob_0_138, "./Pages/Web/Partials/WhyChoose.vue": __vite_glob_0_139, "./Pages/Web/Payment.vue": __vite_glob_0_140, "./Pages/Web/Projects/Index.vue": __vite_glob_0_141, "./Pages/Web/Projects/Show.vue": __vite_glob_0_142 });
