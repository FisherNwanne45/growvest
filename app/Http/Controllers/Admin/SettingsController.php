...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        $contact_page = count(get_option('contact_page', locale: true)) ? get_option('contact_page', locale: true) : get_option('about_page');
        $auth_page = count(get_option('auth_page', locale: true)) ? get_option('auth_page', locale: true) : get_option('about_page');
