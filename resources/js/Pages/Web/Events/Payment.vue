...
const submit = (gateway_id) => {
  ...
  router.post(route("event-payments.store"), {
    ...
    <div class="payment-content">
      ...
      <div class="payment-details">
        <table class="payment-table">
          ...
          <tr>
            <td>{{ trans("Seat No") }}</td>
            <td class="text-center">{{event.seat_prefix + seat_no.join(", " + event.seat_prefix) }}</td>
          </tr>
      ...
      <div class="text-center">
        <Link :href="route('events.index')" class="payment-cancel-btn">
