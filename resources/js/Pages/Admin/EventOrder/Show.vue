...
<template>
  <main class="container flex-grow p-4 sm:p-6">
          ...
          <div class="min-w-[38rem]">
            <div
              ...
              <table class="table table-striped table-hover table-md">
                <tbody>
                  <tr>
                    <td class="col-9">{{ trans("Event Name") }}</td>
                    <td class="col-3">
                      <p class="text-right">
                        {{ trans("Price") }}
                      </p>
            ...
            <div class="flex items-stretch justify-between mt-4">
              <div class="w-2/5">
                ...
                <p class="py-0 my-2 text-sm font-semibold" v-if="order.gateway?.name">
                  {{ trans("Payment Id") }}:
                  <span class="font-normal">{{ order.payment_id }}</span>
                </p>
                <div class="">
                  <template v-if="meta != null && order.status == 'pending'">
              ...
              <div class="space-y-3 text-end px-6">
                ...
                <div class="flex items-center gap-x-2 min-w-[272px]">
    ...
    <div class="mt-4 card">
      <form @submit.prevent="updateOrder('/admin/event-orders/' + order.id)">
