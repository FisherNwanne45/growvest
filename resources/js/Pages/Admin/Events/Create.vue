...
const createEvent = () => {
  form.post(route('admin.events.store'), {
    onSuccess: () => {
      form.reset()
      notify.success(trans('Event has been added successfully'))
    }
  })
}
</script>
        ...
        <div class="card-body">
          <form @submit.prevent="createEvent" class="grid grid-cols-2 gap-2">
            ...
            <div class="mb-2">
              ...
              <input type="text" v-model="form.seat_prefix" class="input" maxlength="5" />
            ...
            <div class="col-span-full text-end">
              <SpinnerBtn :processing="form.processing" :btn-text="trans('Create Event')" />
            </div>
          </form>
        </div>
      </div>
