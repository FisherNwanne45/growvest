<template>
  <main class="container flex-grow p-4 sm:p-6">
    <PageHeader title="Create a language" :segments="segments" :buttons="buttons" />
    <div class="space-y-6">
            ...
            <tr v-for="(language, key) in languages" :key="key">
              ...
              <td class="flex justify-end gap-3">
                ...
                <a
                  ...
                  @click="deleteRow(route('admin.language.destroy', key))"
...
const storeLanguage = () => {
  form.post(route('admin.language.store'), {
    onSuccess: () => {
      form.reset()
      notify.success(trans('New Language has been added successfully'))
