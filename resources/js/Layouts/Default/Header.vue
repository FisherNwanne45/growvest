    ...
    <div class="bg-primary hidden py-3 text-white md:block">
      <div class="container">
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          >
            <li class="mr-4">{{ topBar?.left_text }}</li>
            <li class="pl-4">
          ...
          >
            <li class="px-2">{{ topBar.right_text }}:</li>

            <li v-for="(link, platform) in socials" :key="platform">
              <a v-if="link" :href="link" target="_blank" class="px-2 text-lg">
               
                <iconify-icon :icon="`bxl:${platform}`"></iconify-icon>
              </a>
            </li>
          </ul>
        </div>
